...
"[project]/src/lib/debug.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const debugService = {
    ...
    async testConnection () {
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('count').limit(1);
            if (error) {
                return {
                    success: false,
    ...
    async listUsers () {
        try {
            const { data: users, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('id, name, phone_number, role').order('name', {
                ascending: true
            });
            if (error) {
    ...
    async findUserByPhone (phone) {
        try {
            const { data: users, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('*').eq('phone_number', phone);
            if (error) {
                return {
                    user: null,
                    error: error.message
...
function LoginPage() {
    ...
    const handleDebug = async ()=>{
        try {
            const { users, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$debug$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["debugService"].listUsers();
            if (error) {
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsLoading(true);
        try {
            const { user, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authService"].login(phoneNumber, password);
            if (error) {
                setErrors({
                    general: error
                });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__05b2b9ff._.js.map