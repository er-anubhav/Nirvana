...
"[project]/src/lib/supabase-logger.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabase-logger.ts [app-ssr] (ecmascript)");
;
;
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logSupabaseConnection"])('connecting', {
    url: supabaseUrl,
...
const validateSupabaseConnection = async ()=>{
    try {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logSupabaseDebug"])('Starting connection validation');
        // Test the connection by making a simple query
        const { data, error } = await supabase.from('_health_check').select('*').limit(1);
        if (error) {
            // If health check table doesn't exist, try a different approach
            if (error.code === 'PGRST116' || error.message.includes('does not exist')) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logSupabaseDebug"])('Health check table not found, testing with auth instead');
                // Test with auth session
                const { data: session, error: authError } = await supabase.auth.getSession();
                if (authError) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logSupabaseError"])('auth_connection_test', authError);
                    return false;
                }
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logSupabaseConnection"])('connected', {
                    method: 'auth_test',
                    hasActiveSession: !!session.session
                });
                return true;
            } else {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logSupabaseError"])('health_check', error);
                return false;
            }
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logSupabaseConnection"])('connected', {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logSupabaseError"])('connection_validation', error);
        return false;
    }
};
...
if ("TURBOPACK compile-time truthy", 1) {
    validateSupabaseConnection().then((isValid)=>{
        if (isValid) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logSupabaseConnection"])('failed', {
                autoValidation: true
            });
        }
    });
...
const logDatabaseOperation = (operation, table, details)=>{
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logSupabaseDebug"])(`Database Operation: ${operation.toUpperCase()} on ${table}`, details);
};
const handleSupabaseError = (error, context)=>{
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logSupabaseError"])(context, error);
...
const authService = {
    ...
    async login (phone, password) {
        try {
            ...
            const { data: users, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('*').eq('phone_number', phoneWithCountryCode).limit(1);
...
"[project]/src/lib/complaints.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const complaintService = {
    ...
    async getUserComplaints (userId) {
        try {
            const { data: complaints, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('complaints').select('*').eq('user_id', userId).order('created_at', {
                ascending: false
            });
            if (error) {
    ...
    async getAllComplaints (limit = 50) {
        try {
            const { data: complaints, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('complaints').select('*').order('created_at', {
                ascending: false
            }).limit(limit);
            if (error) {
    ...
    async getComplaintById (complaintId) {
        try {
            const { data: complaint, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('complaints').select('*').eq('id', complaintId).single();
            if (error) {
    ...
    async getUserStats (userId) {
        try {
            const { data: complaints, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('complaints').select('status').eq('user_id', userId);
            if (error) {
    ...
    async getCategories () {
        try {
            const { data: categories, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('categories').select('*').order('name');
            if (error) {
    ...
    async createComplaint (complaintData, userId) {
        try {
            const { data: complaint, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('complaints').insert({
...
"[project]/src/app/citizen/gallery/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$complaints$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/complaints.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function ComplaintGallery() {
    ...
    const [filteredComplaints, setFilteredComplaints] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const user = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authService"].getCurrentUser();
        if (!user) {
    ...
    const loadUserComplaints = async (userId)=>{
        setLoading(true);
        try {
            const { data: complaintsData, error: complaintsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$complaints$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["complaintService"].getUserComplaints(userId);
            if (complaintsError) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (searchTerm) {
            filtered = filtered.filter((complaint)=>complaint.title.toLowerCase().includes(searchTerm.toLowerCase()) || complaint.description.toLowerCase().includes(searchTerm.toLowerCase()));
        }
                    ...
                    !error && filteredComplaints.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["motion"].div, {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    (searchTerm || selectedCategory !== 'all') && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: ()=>{
                                            setSearchTerm('');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f3561e58._.js.map