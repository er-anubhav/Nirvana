    ...
    def webhook():
        ...
        if request.method == 'POST':
            try:
                ...
                logger.info(f"Processing message from {from_number}, type: {msg_type}")                # Extract message content based on type
                msg_body = None
                media_msg = None
                location_msg = None
                voice_msg = None
                ...
                if msg_type == 'text':
                    ...
                    return 'OK', 200                # Process complaint using our new system
